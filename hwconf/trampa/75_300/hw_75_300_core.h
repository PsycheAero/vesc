...
// NTC Termistors
#define NTC_RES(adc_val)		((4095.0 * 5000.0) / (float)adc_val - 5000.0)
#define NTC_TEMP(adc_ind)		hw75_300_get_temp()

#define NTC_RES_MOTOR(adc_val)	(1000.0  * 4095.0 / (float)adc_val - 1000.0) // Motor temp sensor on low side
#define NTC_TEMP_MOTOR(beta)	60.0
